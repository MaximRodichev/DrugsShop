...
/// <summary>
/// Базовая сущность для всех сущностей домена, позволяет сравнивать объекты по идентификатору
/// </summary>
public abstract class BaseEntity
{
    ...
    /// <summary>
    /// Конструктор по умолчанию, инициализирующий уникальный идентификатор.
    /// </summary>
